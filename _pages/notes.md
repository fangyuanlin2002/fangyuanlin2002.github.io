...
<div class="notes-grid">
  <article class="note-card">
    ...
    <p>Full notes + TeX source code on graduate-level probability theory.</p>
  </article>
  ...
  <article class="note-card">
    ...
    <p>Full notes + TeX source code, covering entropy, typicality, channel coding, and more.</p>
  </article>
  ...
  <article class="note-card">
    ...
    <p>Full notes + TeX source code on graduate-level statistical signal processing.</p>
  </article>
  ...
  <article class="note-card">
    ...
    <p>Full notes + TeX source code on graduate-level mathematical statistics.</p>
  </article>

  <article class="note-card">
    <h2>
    <a href="https://www.overleaf.com/read/tpdgvtvjctfy#bc635c">High Dimensional Probability and Statistics</a>
      <embed src="https://fangyuanlin2002.github.io/files/common-derivatives.pdf" width="100%" height="200px" type="application/pdf"> 
    </h2>
    <p>
      Full notes + TeX source code on graduate-level high dimensional probability and statistics.
    </p>
  </article>
